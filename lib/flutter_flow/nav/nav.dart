...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomePageWidget() : LoginsmsPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            FFRoute(
              name: 'LoginsmsPage',
              path: 'loginsmsPage',
              builder: (context, params) => LoginsmsPageWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              path: 'createNewDriverProfile',
              builder: (context, params) => CreateNewDriverProfileWidget(
                ...
                driverListRef: params.getParam(
                  'driverListRef',
                  ParamType.DocumentReference,
                  isList: false,
                  collectionNamePath: ['driver_list'],
                ),
              ),
            ),
            FFRoute(
              name: 'ConfirmSmsPage',
              path: 'confirmSmsPage',
              builder: (context, params) => ConfirmSmsPageWidget(
                number: params.getParam(
                  'number',
                  ParamType.String,
                ),
